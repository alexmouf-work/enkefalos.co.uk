...
**Read [AGENTS.md](AGENTS.md).** It is the entry point for every contributor to this repository,
agent or human: the charter's Tier 0 core verbatim, where work happens, house style, and pointers to
everything else.

**About to publish anything?** This repository is public, its history is permanent, and some of what
it serves is linked from email that has already been sent and cannot be edited. Never commit a
secret. Never move, rename or delete a file that has been served. Charter §1 and
[docs/charter/engineering-practices.md](docs/charter/engineering-practices.md) §7.
...
`Co-Authored-By` trailer. Charter §6.5.

This file deliberately holds no rules of its own. Two documents stating the same rule drift, and the
copy that drifts is the one people read.
